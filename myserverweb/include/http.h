...
int putHTTPRESOURCE(httpThreadContext*,LPCONNECTION s,char *filename,int systemrequest=false,int OnlyHeader=false,int firstByte=0,int lastByte=-1,int yetmapped=0);
