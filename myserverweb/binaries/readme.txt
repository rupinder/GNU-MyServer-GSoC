...
--------------------------------------------CURRENT STATUS------------------------------------------ MyServer isn't at a mature status too if you are interested to complete anything in the TODO list please contact the project administrator on SourceForge.
The linux portion is not suitable for running as root due to posable security flaws in the program.  To run the server as a user, you must change the port to something like 8080 in the virtualhost configuration because users can only use port numbers larger than 1024. 

---------------------------------------------ADDITIONAL INFO---------------------------------------- For additional info and news about this project see the project site at:  	
