...
To run the server as a user, you must change the port to something like 8080 in the virtualhost configuration because under *nix users can only use port numbers larger than 1024. 
