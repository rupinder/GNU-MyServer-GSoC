...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" 		"0.8.4.1"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" 		"0.8.4"
VIAddVersionKey /LANG=${LANG_ENGLISH} "InternalName" 		"Last of 2006"
;VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalTrademarks" 	""
VIAddVersionKey /LANG=${LANG_ENGLISH} "OriginalFilename"	"MyServer-win32-0.8.4-rc1.exe"
