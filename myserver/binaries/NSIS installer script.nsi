...
Name "MyServer"
OutFile "MyServer-win32-0.8.9-rc1.exe"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" 		"0.8.9.1"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" 		"0.8.9"
VIAddVersionKey /LANG=${LANG_ENGLISH} "InternalName" 		"Einstein"
;VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalTrademarks" 	""
VIAddVersionKey /LANG=${LANG_ENGLISH} "OriginalFilename"	"MyServer-win32-0.8.9-rc1.exe"
