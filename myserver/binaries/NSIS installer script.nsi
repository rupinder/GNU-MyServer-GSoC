...
Name "MyServer"
OutFile "MyServer-win32-0.8.8-rc1.exe"

; Versioning Information
VIProductVersion "0.8.8.1"
...
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileVersion" 		"0.8.8.1"
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductVersion" 		"0.8.8"
VIAddVersionKey /LANG=${LANG_ENGLISH} "InternalName" 		"RC1"
;VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalTrademarks" 	""
VIAddVersionKey /LANG=${LANG_ENGLISH} "OriginalFilename"	"MyServer-win32-0.8.8-rc1.exe"
